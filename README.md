...
Rekrystalizace nastává postupně v určitém intervalu teplot, úplná rekrystalizace pak při určité teplotě, kterou označujeme jako teplotu rekrystalizační. Rekrystalizační teplota ( T\_{\mathrm{r\}} ) je u různých kovů a slitin různě vysoká. Bylo zjištěno, že závisí na teplotě tavení ( T\_{\mathrm{t\}} ). U většiny kovů se rovná čtyřem desetinám teploty tavení, měřené v&#x20;
